  ...
  return (
    <div className='pb-16 '>
      ...
      <div className='text-center mb-24'>
        ...
        <label htmlFor="upload2" className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-blue-800 to-blue-300 m-auto hover:scale-105 transition-all duration-700'>
